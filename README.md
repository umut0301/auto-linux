...
*   **v56.10 (2024-07-27)**
    *   **🚀 增强**: 优化 WireGuard "修改接口网段" 功能，实现客户端 IP 自动同步更新，并自动应用配置。
    *   **🔧 优化**: 为 `modify_interface_subnet_logic` 函数添加详细注释，提升代码可读性。
*   **v56.9 (2024-07-27)**
    *   **✨ 新增**: WireGuard 接口管理菜单，整合删除、修改端口功能。
    *   **✨ 新增**: WireGuard 接口管理中新增 "修改接口网段"、"修改接口MTU"、"重启接口" 功能。
    *   **🔧 优化**: 确保原有删除和修改端口功能逻辑完全保留。
*   **v56.8 (2024-07-27)**
    *   **✨ 新增**: WireGuard 服务端和客户端支持自定义 MTU 值。
    *   **🔧 优化**: 客户端添加时自动继承服务端 MTU 设置，配置重构时保留 MTU 设置。
*   **v56.5 (2024-07-26)**
